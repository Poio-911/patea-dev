...
void main() {
  ...
  test('AppColors y PateaColors.game no pueden separarse', () {
    ...
    final pares = <String, List<Color>>{
      ...
      'onPrimary': [AppColors.onPrimary, g.onPrimary],
      'overlaySubtle': [AppColors.overlaySubtle, g.overlaySubtle],
      'overlayLine': [AppColors.overlayLine, g.overlayLine],
      'overlayStrong': [AppColors.overlayStrong, g.overlayStrong],
