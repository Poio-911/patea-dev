          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Icon(Icons.shield_outlined, size: 18, color: AppColors.voltNeon),
                      const SizedBox(width: 8),
                      Text('EQUIPOS GUARDADOS', style: AppTypography.headline(size: 13, weight: FontWeight.w800, color: AppColors.voltNeon)),
                      const Spacer(),
                      TextButton.icon(
                        onPressed: () => context.push('/groups/teams/new?groupId=$groupId'),
                    ...
                    data: (teams) {
                      if (teams.isEmpty) {
                        return Padding(
                          ...
                          child: Text('Todavía no hay equipos. Creá el primero.', style: AppTypography.body(size: 12, color: AppColors.textMuted)),
                        );
                      }
                      return Column(
                        children: teams
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text(team.name, style: AppTypography.body(size: 14, weight: FontWeight.w700)),
                                              Text('${team.members.length} jugadores', style: AppTypography.body(size: 11, color: AppColors.textMuted)),
                                            ],
                                          ),
                                        ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    Icon(Icons.newspaper_outlined, size: 18, color: AppColors.voltNeon),
                    const SizedBox(width: 8),
                    Text('EN AGENDA', style: AppTypography.headline(size: 13, weight: FontWeight.w800, color: AppColors.voltNeon)),
                  ]),
                  const SizedBox(height: 10),
                  if (upcoming.isEmpty)
                    ...
                    ...upcoming.take(5).map((m) => Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Row(
                              children: [
                                Expanded(child: Text(m.title, style: AppTypography.body(size: 13, weight: FontWeight.w600), maxLines: 1, overflow: TextOverflow.ellipsis)),
