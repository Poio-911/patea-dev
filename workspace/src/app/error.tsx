    ...
    <div style={{
      ...
      <div style={{ maxWidth: '28rem' }}>
        ...
        <div style={{ marginTop: '2rem', display: 'flex', gap: '1rem', justifyContent: 'center' }}>
          <button onClick={() => reset()} style={{ padding: '0.5rem 1rem', cursor: 'pointer', border: '1px solid #ccc', borderRadius: '4px' }}>
            Intentar de nuevo
          </button>
          <a href="/dashboard" style={{ padding: '0.5rem 1rem', textDecoration: 'none', border: '1px solid #ccc', borderRadius: '4px' }}>
            Volver al inicio
          </a>
        </div>
      </div>
