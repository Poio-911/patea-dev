...
13. [Ventajas Competitivas](#13-ventajas-competitivas)
14. [Oportunidad de Mercado](#14-oportunidad-de-mercado)
...
│                                                                 │
│  RED SOCIAL          COMPETICIONES        MONETIZACIÓN          │
│  ──────────          ────────────         ────────────          │
│  • Feed              • Ligas              • Créditos IA         │
│  • Seguidos          • Copas              • Paquetes            │
│  • Reacciones        • Brackets           • Premium (futuro)    │
└─────────────────────────────────────────────────────────────────┘
```
...
| **MercadoPago** | Procesamiento de pagos (infraestructura lista) |
...
#### Fase 1: Freemium (Actual)

| Feature | Free | Premium (Futuro) |
|---------|------|------------------|
| Crear partidos | ✅ Ilimitados | ✅ |
| Unirse a grupos | ✅ 5 grupos | Ilimitados |
| Ver estadísticas | ✅ Básicas | Avanzadas |
| Generar equipos IA | ✅ Ilimitado | ✅ |
| Generar imágenes IA | 3/mes gratis | Ilimitadas |
| Crear ligas/copas | ✅ 1 activa | Ilimitadas |
| Exportar datos | ❌ | ✅ |

#### Fase 2: Créditos IA (Infraestructura Lista)

| Paquete | Créditos | Precio (UYU) | Descuento |
|---------|----------|--------------|-----------|
| Starter | 10 | $200 | - |
| Pro | 30 | $500 | 17% |
| Elite | 100 | $1,200 | 40% |
...
**Uso de créditos:**
- 1 crédito = 1 imagen de carta IA
- 2 créditos = 1 imagen duo
- 1 crédito = Análisis detallado de progresión

#### Fase 3: Suscripción Premium (Roadmap)

| Plan | Precio/mes | Incluye |
|------|------------|---------|
| **Pateá Pro** | $300/mes | Grupos ilimitados, 20 créditos/mes, stats avanzadas |
| **Pateá Club** | $800/mes | Todo Pro + Ligas ilimitadas + API access + Soporte |

#### Fase 4: B2B - Ligas Oficiales (Futuro)

Licenciamiento para ligas amateur organizadas:
...
| Año | MAU | Conversión Pago | ARPU (UYU) | MRR (UYU) |
|-----|-----|-----------------|------------|-----------|
| 1 | 5,000 | 2% | $400 | $40,000 |
| 2 | 25,000 | 5% | $500 | $625,000 |
| 3 | 100,000 | 8% | $600 | $4,800,000 |

*Basado en mercado uruguayo, expandible a LATAM*
...
|---------|-------------|--------|
| **DAU/MAU** | Ratio de usuarios activos | > 40% |
| **Partidos/Semana/Grupo** | Frecuencia de uso | > 1.5 |
| **Evaluaciones Completadas** | Engagement post-partido | > 70% |
| **Tiempo en App** | Sesión promedio | > 8 min |
| **Retención D7** | Usuarios que vuelven a la semana | > 50% |
| **Retención D30** | Usuarios que vuelven al mes | > 30% |

### Métricas de Negocio

| Métrica | Descripción | Target Año 1 |
|---------|-------------|--------------|
| **CAC** | Costo de adquisición | < $50 UYU |
| **LTV** | Valor de vida del cliente | > $500 UYU |
| **LTV/CAC** | Ratio de rentabilidad | > 10x |
...
| Métrica | Descripción | Target |
|---------|-------------|--------|
| **Fairness Score** | Equilibrio de equipos generados | > 85% |
| **Chronicle Engagement** | Crónicas leídas/generadas | > 60% |
| **Image Generation Success** | Imágenes aceptadas/generadas | > 90% |
...
🔄 **En Desarrollo:**
- [ ] Activar sistema de pagos MercadoPago
...
- [ ] Streaming integrado (YouTube/Twitch)
...
| **Real-time First** | Arquitectura diseñada para tiempo real |
...
| Ventaja | Descripción |
|---------|-------------|
| **First Mover LATAM** | No hay competencia directa con IA |
| **Cultura Futbolera** | Diseñado para Uruguay, escalable a LATAM |
| **Idioma Nativo** | Tags y crónicas en español rioplatense |

---

## 14. Oportunidad de Mercado

### TAM (Total Addressable Market)

**Fútbol Amateur Global:**
- 265 millones de jugadores registrados en federaciones
- 500+ millones de jugadores recreativos no registrados
- Mercado de apps deportivas: $5.5B (2024)

### SAM (Serviceable Addressable Market)

**LATAM - Fútbol Amateur:**
- Uruguay: 500K jugadores amateur activos
- Argentina: 3M jugadores amateur activos
- Brasil: 15M jugadores amateur activos
- México: 8M jugadores amateur activos
- Colombia: 4M jugadores amateur activos
- **Total SAM:** ~30M jugadores

### SOM (Serviceable Obtainable Market)

**Uruguay (Foco Año 1-2):**
- Target: Grupos de amigos que juegan semanalmente
- Estimación: 50,000 grupos activos
- Promedio: 15 jugadores/grupo
- **SOM Año 2:** 25,000 usuarios (3% penetración)
