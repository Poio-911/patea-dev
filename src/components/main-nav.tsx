  ...
  return (
    <SidebarProvider>
      ...
      <div className="relative h-screen w-full">
                ...
                <div className="flex items-center gap-3">
                  {isPlayerPublic && (
                    <div className="hidden md:flex items-center mr-2">
                      <Badge variant="secondary" className="gap-1.5 text-xs font-medium bg-primary/10 text-primary border-primary/20 hover:bg-primary/20 transition-colors cursor-help" title="Tu perfil es público y visible para otros organizadores">
                        <Eye className="h-3.5 w-3.5" />
                        <span className="hidden lg:inline">Público</span>
                      </Badge>
                    </div>
                  )}
        ...
        <main className={cn(
          "h-screen overflow-y-auto pt-4 md:pl-[var(--sidebar-width)] transition-[padding] duration-300 ease-in-out",
