        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-4">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                  <div>
                      ...
                      />
                       {form.formState.errors.date && <p className="text-xs text-destructive mt-1">{form.formaste.errors.date.message}</p>}
                  </div>
                  <div>
            ...
            <div className="space-y-4">
                ...
                {allPlayers.length > 0 ? (
                    <div className="max-h-[400px] overflow-y-auto space-y-2 border p-2 rounded-md">
