...
export function CheckeredJersey({ primaryColor, secondaryColor, className }: JerseyProps) {
        ...
        <svg viewBox="0 0 486 420" className={className} xmlSpace="preserve">
             <defs>
                <clipPath id={id}>
                 ...
                 <pattern id={`pattern-${id}`} width="80" height="80" patternUnits="userSpaceOnUse">
                    <rect width="40" height="40" fill={primaryColor} />
                    <rect x="40" y="0" width="40" height="40" fill={secondaryColor} />
                    <rect x="0" y="40" width="40" height="40" fill={secondaryColor} />
                    <rect x="40" y="40" width="40" height="40" fill={primaryColor} />
                </pattern>
            </defs>
            <g clipPath={`url(#${id})`}>
