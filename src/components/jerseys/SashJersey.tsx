...
export function SashJersey({ primaryColor, secondaryColor, className }: JerseyProps) {
  ...
  return (
    <svg viewBox="0 0 486 420" className={className} xmlSpace="preserve">
      ...
      <g clipPath={`url(#${id})`}>
        <rect x="0" y="0" width="486" height="420" fill={primaryColor} />
        <path
          d="M-50,0 L200,0 L536,420 L286,420 Z"
          fill={secondaryColor}
        />
      </g>
    </svg>
