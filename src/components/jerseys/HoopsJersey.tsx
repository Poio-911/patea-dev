...
export function HoopsJersey({ primaryColor, secondaryColor, className }: JerseyProps) {
    const id = `hoops-${primaryColor}-${secondaryColor}`.replace(/#/g, '');
        ...
        <svg viewBox="0 0 486 420" className={className} xmlSpace="preserve">
             <defs>
                <clipPath id={id}>
                 ...
                 <pattern id={`pattern-${id}`} width="100%" height="20%" patternContentUnits="objectBoundingBox">
