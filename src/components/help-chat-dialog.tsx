...
export function HelpChatDialog() {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={cn(
          'fixed bottom-4 right-4 z-50 w-80 max-w-[calc(100vw-2rem)] h-[28rem] flex flex-col bg-card/95 backdrop-blur-lg rounded-xl shadow-2xl border border-border overflow-hidden transition-all pr-[env(safe-area-inset-right)] pb-[env(safe-area-inset-bottom)]',
