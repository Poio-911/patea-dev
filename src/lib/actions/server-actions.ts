...
import {
    createTeamAvailabilityPostAction as createTeamAvailabilityPostDomainAction,
    getAvailableTeamPostsAction as getAvailableTeamPostsDomainAction,
    getUserTeamPostsAction as getUserTeamPostsDomainAction,
    challengeTeamPostAction as challengeTeamPostDomainAction,
    acceptTeamChallengeAction as acceptTeamChallengeDomainAction,
    rejectTeamChallengeAction as rejectTeamChallengeDomainAction,
    deleteTeamAvailabilityPostAction as deleteTeamAvailabilityPostDomainAction,
    sendTeamChallengeAction as sendTeamChallengeDomainAction,
...
export async function createTeamAvailabilityPostAction(
    ...
    return createTeamAvailabilityPostDomainAction(teamId, userId, postData);
}
...
export async function getAvailableTeamPostsAction(userId: string): Promise<{ success: boolean; posts: TeamAvailabilityPost[] } | ErrorResponse> {
    return getAvailableTeamPostsDomainAction(userId);
}

export async function getUserTeamPostsAction(userId: string) {
    return getUserTeamPostsDomainAction(userId);
}
...
export async function challengeTeamPostAction(
    ...
    return challengeTeamPostDomainAction(postId, challengingTeamId, challengerUserId);
}
...
export async function acceptTeamChallengeAction(invitationId: string, teamId: string, userId: string): Promise<{ success: boolean; matchId: string } | ErrorResponse> {
    return acceptTeamChallengeDomainAction(invitationId, teamId, userId);
}

export async function rejectTeamChallengeAction(invitationId: string, teamId: string, userId: string) {
    return rejectTeamChallengeDomainAction(invitationId, teamId, userId);
}

export async function deleteTeamAvailabilityPostAction(postId: string, userId: string) {
    return deleteTeamAvailabilityPostDomainAction(postId, userId);
}
...
export async function sendTeamChallengeAction(challengingTeamId: string, challengedTeamId: string, challengerUserId: string) {
    return sendTeamChallengeDomainAction(challengingTeamId, challengedTeamId, challengerUserId);
}
